<?php include 'modals.php'; ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3 mb-0 text-gray-800">Pending Requests Employee Side</h1>
        </div>
    ...
    <style>
        ...
        thead {
            background-color:rgb(10, 81, 61) !important; /* Bootstrap primary color */
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
            <?php require 'fetch_pendingrequest2.php'; ?>
            </tbody>    
        </table>
        </div>
    </div>
