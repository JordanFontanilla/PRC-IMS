...
<?php require '../IMS/js/ajax/pageloader.php';?>
<body id="page-top">
    <div id="wrapper">
...
<li class="nav-item">
    <a class="nav-link load-user" href="javascript:void(0);">
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item load-inventorylist" href="javascript:void(0);">List</a>
            <a class="collapse-item load-requestlist" href="javascript:void(0);">Requests</a>
            <a class="collapse-item load-returnlist" href="javascript:void(0);">Returns</a>
        </div>
    </div>
</li>
<hr class="sidebar-divider">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">SESSION NAME Placeholder</span>
